...
class RegistroExitosoAdminReservation extends Mailable
{
    ...
    )
    {
        ...
        $this->clave_reservacion = $clave_reservacion;
    ...
    public function content(): Content
    {
        ...
        $monto_total = number_format($this->reservations->monto_total, 2);

        return new Content(
            view: 'emails.registro-exitoso-reservation',
            with:  [
