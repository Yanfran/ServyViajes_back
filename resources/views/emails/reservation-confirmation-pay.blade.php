    ...
    <div class="container-email">
        ...
        <div class="container-detail-user">
            ...
            <p class="text-access-1">
                ...
                de {{ $fechaEntrada ? date('d-m-Y', strtotime($fechaEntrada)) : 'no disponible' }}
                al {{ $fechaSalida ? date('d-m-Y', strtotime($fechaSalida)) : 'no disponible' }}
            </p>
            @if($isNewUser)
                <h3>Accesos</h3>
                <table>
        ...
        <div class="container-detail-reservation">
            ...
            <table>
                <tbody>
                    <tr>
                        <td>
                            <p class="columns">Clave de reservación: </p> 
                        </td>
                        <td>
